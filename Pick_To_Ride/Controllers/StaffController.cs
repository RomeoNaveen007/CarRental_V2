...
namespace Pick_To_Ride.Controllers
{
    public class StaffController : Controller
    {
        ...
        public async Task<IActionResult> Create(StaffViewModel vm, string role = "Staff")
        {
            ...
            // Handle profile image → store temp path
        ...
        public async Task<IActionResult> Edit(Guid id)
        {
            ...
            var vm = new StaffViewModel
            {
                ...
                UserId = staff.UserId,
                FirstName = staff.User.FullName.Split(' ')[0],
                LastName = staff.User.FullName.Split(' ').Length > 1 ? staff.User.FullName.Split(' ')[1] : "",
        ...
        public async Task<IActionResult> Edit(StaffViewModel vm)
        {
            ...
            staff.User.FullName = $"{Capitalize(vm.FirstName)} {Capitalize(vm.LastName)}";
        ...
        private async Task SendOtpEmail(string toEmail, string otp)
        {
            ...
            const string fromPassword = "pqlvgvdmpvhdwudw"; // config recommended
